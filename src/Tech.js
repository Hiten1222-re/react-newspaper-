...
export default class Tech extends Component {
    ...
    async componentDidMount(props){
      ...
      let url=`https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3dfdb9102b154deab66608dfeb6457b9&page=technology&pageSize=5`
    ...
    fetchMoreData=async ()=>{
      ...
      let url=`https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3dfdb9102b154deab66608dfeb6457b9&page=${this.state.page}&pageSize=5`
