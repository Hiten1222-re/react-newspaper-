...
export default class Heal extends Component {
    ...
    async componentDidMount(props){
      ...
      let url=`https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=3dfdb9102b154deab66608dfeb6457b9&page=health&pageSize=5`
    ...
    fetchMoreData=async ()=>{
      ...
      let url=`https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=3dfdb9102b154deab66608dfeb6457b9&page=${this.state.page}&pageSize=5`
      this.setState({page:this.state.page+1})
      let data= await fetch(url)
      let pars= await data.json()
